...
const documents = {
    ...
    "mutation UpdateUserProfile($username: String, $gender: String, $section: String, $profileImg: Upload, $address: String, $newPassword: String, $currentConfirmation: String, $birthdate: DateTime) {\n  updateUserProfile(\n    username: $username\n    gender: $gender\n    section: $section\n    profile_img: $profileImg\n    address: $address\n    new_password: $newPassword\n    current_confirmation: $currentConfirmation\n    birthdate: $birthdate\n  ) {\n    username\n    first_name\n    last_name\n    address\n    profile_img\n    age\n    gender\n    section\n  }\n}": types.UpdateUserProfileDocument,
    "query User {\n  user {\n    id\n    username\n    access_level\n    password\n    token_version\n    first_name\n    last_name\n    address\n    section\n    profile_img\n    age\n    gender\n  }\n}": types.UserDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation UpdateUserProfile($username: String, $gender: String, $section: String, $profileImg: Upload, $address: String, $newPassword: String, $currentConfirmation: String, $birthdate: DateTime) {\n  updateUserProfile(\n    username: $username\n    gender: $gender\n    section: $section\n    profile_img: $profileImg\n    address: $address\n    new_password: $newPassword\n    current_confirmation: $currentConfirmation\n    birthdate: $birthdate\n  ) {\n    username\n    first_name\n    last_name\n    address\n    profile_img\n    age\n    gender\n    section\n  }\n}"): (typeof documents)["mutation UpdateUserProfile($username: String, $gender: String, $section: String, $profileImg: Upload, $address: String, $newPassword: String, $currentConfirmation: String, $birthdate: DateTime) {\n  updateUserProfile(\n    username: $username\n    gender: $gender\n    section: $section\n    profile_img: $profileImg\n    address: $address\n    new_password: $newPassword\n    current_confirmation: $currentConfirmation\n    birthdate: $birthdate\n  ) {\n    username\n    first_name\n    last_name\n    address\n    profile_img\n    age\n    gender\n    section\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
