 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation UpdateUserGroupRoles($roles: [String], $groupId: Int, $userId: Int) {\n  updateUserGroupRoles(roles: $roles, group_id: $groupId, user_id: $userId) {\n    newRoles\n    user {\n      id\n      username\n      first_name\n      last_name\n      profile_img\n    }\n  }\n}"): (typeof documents)["mutation UpdateUserGroupRoles($roles: [String], $groupId: Int, $userId: Int) {\n  updateUserGroupRoles(roles: $roles, group_id: $groupId, user_id: $userId) {\n    newRoles\n    user {\n      id\n      username\n      first_name\n      last_name\n      profile_img\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
